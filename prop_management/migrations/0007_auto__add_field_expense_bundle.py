...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Expense.bundle'
        db.add_column(u'prop_management_expense', 'bundle',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prop_management.PropertyBundle'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Expense.bundle'
        db.delete_column(u'prop_management_expense', 'bundle_id')
