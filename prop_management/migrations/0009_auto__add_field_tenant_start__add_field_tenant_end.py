...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tenant.start'
        db.add_column(u'prop_management_tenant', 'start',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Tenant.end'
        db.add_column(u'prop_management_tenant', 'end',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tenant.start'
        db.delete_column(u'prop_management_tenant', 'start')

        # Deleting field 'Tenant.end'
        db.delete_column(u'prop_management_tenant', 'end')
