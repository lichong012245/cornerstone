...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.property'
        db.add_column(u'prop_management_account', 'property',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['prop_management.Property'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Account.property'
        db.delete_column(u'prop_management_account', 'property_id')
