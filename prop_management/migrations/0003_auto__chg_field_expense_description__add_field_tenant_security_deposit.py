...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Tenant.security_deposit'
        db.add_column(u'prop_management_tenant', 'security_deposit',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Expense.description'
        db.alter_column(u'prop_management_expense', 'description', self.gf('django.db.models.fields.CharField')(max_length=500))
        # Deleting field 'Tenant.security_deposit'
        db.delete_column(u'prop_management_tenant', 'security_deposit')
